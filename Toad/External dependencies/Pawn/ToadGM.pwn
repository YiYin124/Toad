...
native GM_OnPlayerConnect(playerid);// Y
native GM_OnPlayerDisconnect(playerid, reason);// Y
native GM_OnPlayerSpawn(playerid);// Y
native GM_OnPlayerDeath(playerid, killerid, reason);// Y
native GM_OnVehicleSpawn(vehicleid);
native GM_OnVehicleDeath(vehicleid, killerid);// Y
native GM_OnPlayerText(playerid, text[]);// Y
native GM_OnPlayerCommandText(playerid, cmdtext[]);
native GM_OnPlayerRequestClass(playerid, classid);
native GM_OnPlayerEnterVehicle(playerid, vehicleid, ispassenger);// Y
native GM_OnPlayerExitVehicle(playerid, vehicleid);// Y
native GM_OnPlayerStateChange(playerid, newstate, oldstate);// Y
native GM_OnPlayerEnterCheckpoint(playerid);// Y
native GM_OnPlayerLeaveCheckpoint(playerid);// Y
native GM_OnPlayerEnterRaceCheckpoint(playerid);// Y
native GM_OnPlayerLeaveRaceCheckpoint(playerid);// Y

native GM_OnPlayerRequestSpawn(playerid);
native GM_OnObjectMoved(objectid);
native GM_OnPlayerObjectMoved(playerid, objectid);// Y
native GM_OnPlayerPickUpPickup(playerid, pickupid);// Y
...
native GM_OnPlayerInteriorChange(playerid, newinteriorid, oldinteriorid);// Y
native GM_OnPlayerKeyStateChange(playerid, newkeys, oldkeys);
native GM_OnRconLoginAttempt( ip[], password[], success );
native GM_OnPlayerUpdate(playerid);// Y
native GM_OnPlayerStreamIn(playerid, forplayerid);// Y
native GM_OnPlayerStreamOut(playerid, forplayerid);// Y
...
native GM_OnPlayerTakeDamage(playerid, issuerid, Float:amount, weaponid);// Y
native GM_OnPlayerGiveDamage(playerid, damagedid, Float:amount, weaponid);// Y
...
native GM_OnNPCConnect(npcid);// Y
native GM_OnNPCDisconnect(npcid, reason);// Y
native GM_OnNPCSpawn(npcid);// Y
native GM_OnNPCDeath(npcid, killerid, reason);// Y
native GM_OnNPCText(npcid, text[]);// Y
native GM_OnNPCEnterVehicle(npcid, vehicleid, ispassenger);// Y
native GM_OnNPCExitVehicle(npcid, vehicleid);// Y
native GM_OnNPCStateChange(npcid, newstate, oldstate);// Y
native GM_OnNPCEnterCheckpoint(npcid);// Y
native GM_OnNPCLeaveCheckpoint(npcid);// Y
native GM_OnNPCEnterRaceCheckpoint(npcid);// Y
native GM_OnNPCLeaveRaceCheckpoint(npcid);// Y
native GM_OnNPCObjectMoved(npcid, objectid);// Y
native GM_OnNPCPickUpPickup(npcid, pickupid);// Y
native GM_OnNPCInteriorChange(npcid, newinteriorid, oldinteriorid);// Y
native GM_OnNPCUpdate(npcid);// Y
native GM_OnNPCStreamIn(npcid, forplayerid);// Y
native GM_OnNPCStreamOut(npcid, forplayerid);// Y
native GM_OnNPCTakeDamage(npcid, issuerid, Float:amount, weaponid);// Y
native GM_OnNPCGiveDamage(npcid, damagedid, Float:amount, weaponid);// Y
...
{
	if (IsPlayerNPC(playerid)) return GM_OnNPCConnect(playerid);
	return GM_OnPlayerConnect(playerid);
}

public OnPlayerDisconnect(playerid, reason)
{
    if (IsPlayerNPC(playerid)) return GM_OnNPCDisconnect(playerid, reason);
	return GM_OnPlayerDisconnect(playerid, reason);
}

public OnPlayerSpawn(playerid)
{
    if (IsPlayerNPC(playerid)) return GM_OnNPCSpawn(playerid);
	return GM_OnPlayerSpawn(playerid);
}

public OnPlayerDeath(playerid, killerid, reason)
{
    if (IsPlayerNPC(playerid)) return GM_OnNPCDeath(playerid, killerid, reason);
	return GM_OnPlayerDeath(playerid, killerid, reason);
}
...
{
	if (IsPlayerNPC(playerid)) return GM_OnNPCText(playerid, text);
	return GM_OnPlayerText(playerid, text);
}
...
{
    if (IsPlayerNPC(playerid)) return GM_OnNPCEnterVehicle(playerid, vehicleid, ispassenger);
	return GM_OnPlayerEnterVehicle(playerid, vehicleid, ispassenger);
}
public OnPlayerExitVehicle(playerid, vehicleid)
{
    if (IsPlayerNPC(playerid)) return GM_OnNPCExitVehicle(playerid, vehicleid);
	return GM_OnPlayerExitVehicle(playerid, vehicleid);
}
public OnPlayerStateChange(playerid, newstate, oldstate)
{
    if (IsPlayerNPC(playerid)) return GM_OnNPCStateChange(playerid, newstate, oldstate);
	return GM_OnPlayerStateChange(playerid, newstate, oldstate);
}
public OnPlayerEnterCheckpoint(playerid)
{
    if (IsPlayerNPC(playerid)) return GM_OnNPCEnterCheckpoint(playerid);
	return GM_OnPlayerEnterCheckpoint(playerid);
}
public OnPlayerLeaveCheckpoint(playerid)
{
    if (IsPlayerNPC(playerid)) return GM_OnNPCLeaveCheckpoint(playerid);
	return GM_OnPlayerLeaveCheckpoint(playerid);
}
public OnPlayerEnterRaceCheckpoint(playerid)
{
    if (IsPlayerNPC(playerid)) return GM_OnNPCEnterRaceCheckpoint(playerid);
	return GM_OnPlayerEnterRaceCheckpoint(playerid);
}
public OnPlayerLeaveRaceCheckpoint(playerid)
{
    if (IsPlayerNPC(playerid)) return GM_OnNPCLeaveRaceCheckpoint(playerid);
	return GM_OnPlayerLeaveRaceCheckpoint(playerid);
}
...
{
    if (IsPlayerNPC(playerid)) return GM_OnNPCObjectMoved(playerid, objectid);
	return GM_OnPlayerObjectMoved(playerid, objectid);
}
public OnPlayerPickUpPickup(playerid, pickupid)
{
    if (IsPlayerNPC(playerid)) return GM_OnNPCPickUpPickup(playerid, pickupid);
	return GM_OnPlayerPickUpPickup(playerid, pickupid);
}
...
{
    if (IsPlayerNPC(playerid)) return GM_OnNPCInteriorChange(playerid, newinteriorid, oldinteriorid);
	return GM_OnPlayerInteriorChange(playerid, newinteriorid, oldinteriorid);
}
...
{
    if (IsPlayerNPC(playerid)) return GM_OnNPCUpdate(playerid);
	return GM_OnPlayerUpdate(playerid);
}
public OnPlayerStreamIn(playerid, forplayerid)
{
    if (IsPlayerNPC(playerid)) return GM_OnNPCStreamIn(playerid, forplayerid);
	return GM_OnPlayerStreamIn(playerid, forplayerid);
}
public OnPlayerStreamOut(playerid, forplayerid)
{
    if (IsPlayerNPC(playerid)) return GM_OnNPCStreamOut(playerid, forplayerid);
	return GM_OnPlayerStreamOut(playerid, forplayerid);
}
...
{
    if (IsPlayerNPC(playerid)) return GM_OnNPCTakeDamage(playerid, issuerid, Float:amount, weaponid);
	return GM_OnPlayerTakeDamage(playerid, issuerid, Float:amount, weaponid);
}
public OnPlayerGiveDamage(playerid, damagedid, Float:amount, weaponid)
{
    if (IsPlayerNPC(playerid)) return GM_OnNPCGiveDamage(playerid, damagedid, Float:amount, weaponid);
	return GM_OnPlayerGiveDamage(playerid, damagedid, Float:amount, weaponid);
}
